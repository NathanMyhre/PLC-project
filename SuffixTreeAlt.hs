{- Important: This SuffixTree type file was obtained from the following URL:

  - Our broken suffix Tree data type is located in suffix-tree.hs.
...
-- Tree Construction, written by some kind stranger on the internet ------------
